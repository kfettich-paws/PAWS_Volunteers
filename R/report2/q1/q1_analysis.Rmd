...
v$assignment_type.1[v$assignment_type.1 == "NA - other_event"] <- "Event"
...
new.vols.by.month <- new.vols.by.month[!is.na(new.vols.by.month$orient_loc.Primary),]

##Then rearrange your data frame
library(reshape2)

new.vols.by.month.g <- new.vols.by.month[new.vols.by.month$orient_loc.Primary=="GF",c(2,3,4)]
colnames(new.vols.by.month.g) <- c("orientation.month", "2017", "2018" )
new.vols.by.month.g <- melt(new.vols.by.month.g, id=c("orientation.month"))
new.vols.by.month.g$value <- new.vols.by.month.g$value*100
colnames(new.vols.by.month.g)[2] <- "year"

p <- ggplot(data=new.vols.by.month.g) + 
  geom_line(aes(x=as.factor(orientation.month), y=value, colour=year, group=year)) +
  scale_colour_manual(values=c("black","red")) +
  scale_y_continuous(name="Percent", limits=c(0, 30), breaks = seq(0, 20,2)) +
  ggtitle("Percent new volunteers attending first orientation at Grays Ferry") + 
...
new.vols.by.month.g <- new.vols.by.month[new.vols.by.month$orient_loc.Primary=="PAC",c(2,3,4)]
colnames(new.vols.by.month.g) <- c("orientation.month", "2017", "2018" )
new.vols.by.month.g <- melt(new.vols.by.month.g, id=c("orientation.month"))
new.vols.by.month.g$value <- new.vols.by.month.g$value*100
colnames(new.vols.by.month.g)[2] <- "year"
...
p <- ggplot(data=new.vols.by.month.g) + 
  ...
  scale_colour_manual(values=c("black","red")) +
  scale_y_continuous(name="Percent", limits=c(0, 30), breaks = seq(0, 20,2)) +
  ggtitle("Percent new volunteers attending first orientation at PAC") + 
  scale_x_discrete(name = "Month")
...
new.vols.by.month.g <- new.vols.by.month[new.vols.by.month$orient_loc.Primary=="NE",c(2,3,4)]
colnames(new.vols.by.month.g) <- c("orientation.month", "2017", "2018" )
new.vols.by.month.g <- melt(new.vols.by.month.g, id=c("orientation.month"))
new.vols.by.month.g$value <- new.vols.by.month.g$value*100
colnames(new.vols.by.month.g)[2] <- "year"
...
p <- ggplot(data=new.vols.by.month.g) + 
  ...
  scale_colour_manual(values=c("black","red")) +
  scale_y_continuous(name="Percent", limits=c(0, 30), breaks = seq(0, 20,2)) +
  ggtitle("Percent new volunteers attending first orientation at Grant Ave") + 
  scale_x_discrete(name = "Month")
