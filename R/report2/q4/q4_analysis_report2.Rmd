...
v17 <- select(v17, keep, YTD.hours, Absence, city_clean, orient_loc.Primary, orient_type.Primary, t.orientation.to.entered, t.entered.to.start, t.start.to.shift1, t.orientation.to.shift1, nTimesVolunteer, ID)

v18 <- select(v18, keep, YTD.hours, Absence, city_clean, orient_loc.Primary, orient_type.Primary, t.orientation.to.entered, t.entered.to.start, t.start.to.shift1, t.orientation.to.shift1, nTimesVolunteer, ID)
```
...
library(gridExtra)
loc_both <- arrangeGrob(loc_17, loc_18, ncol=2)
ggsave(file="volsByLocation.png", loc_both, width=8, height=4)
...
ggsave(file="use_of_tablets.png", g3, width=8, height=3)
