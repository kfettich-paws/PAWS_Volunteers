...
```
# Executive Summary
This report is an update to the report from April 22, 2018. It compares PAWS volunteer statistics from the first half of 2018 to updated statistics from 2017. The following conclusions can be drawn:
...
2. For volunteers from 2018, participation in mentee shifts is a predictor of volunteer engagement: participation in these assignments increased the likelihood of serving more shifts. In contrast, for volunteers from 2017, participation in mentee shifts did not impact volunteer engagement.
...
![http://rladiesphilly.org](RLadiesPhilly.jpg) R-Ladies Philadelphia is the Philadelphia chapter of R-Ladies, a worldwide organization to promote gender diversity in the community of statisticians, data miners, and programmers using the R programming language. The following data scientists contributed to the analysis for this report:
...
**Amy Goodwin Davies, PhD**, is a linguist and data scientist whose research focuses on the grammatical representations involved with word recognition. 

# Problem definition and dataset

This report is a follow-up to the report from Q1 2018, with a focus on the first half of 2018 (Jan 1, 2018 - July 25, 2018). In addition, we assess whether volunteer engagement and retention has changed in 2018, in comparison to 2017. The data used was obtained from the same sources as for the previous report and anonymized prior to analyses.  
...
![PAC](PAC_orientationByMonth2018v2017.png)
...
At **Grays Ferry**, new volunteers signed up for dog mentee shifts took longest to begin their service after orientation (approx. 23 days), while dog and cat care shifts saw volunteers starting approx. 15 days post orientation.
...
![Number of shifts served based on location for 2017 vs 2018](volsByLocation.png)
\newpage

In 2017 and in 2018, PAC had the greatest number of shifts. However, in 2017 Grant Ave had more shifts than Grays Ferry whereas in 2018 Grays Ferry had more shifts than Grant Ave. This appears to be supporting PAWS' goal of increasing volunteering at the Gray's Ferry location.
...
First, we examined the total number of shifts served. 21% of orientation attendees at Grays Ferry have no record of service, while this number stands at 22% at Grant Ave, and 24% at PAC. This remains a fairly small percentage of volunteers, with the majority of new volunteers serving 2 or more shifts across all locations. It is difficult to compare the 2018 volunteers to 2017 volunteers directly in this respect because more time has necessarily elapsed since orientation for the 2017 volunteers. Overall, we expect the service trends to be similar in 2018 as 2017. The Grant Ave. data looks encouraging with more new volunteers serving shifts than last year. 
...
From the analyses in this report, we believe a set of action points can be pursued further. However, it is important to keeep in mind that the information presented here is based primarily on what can be observed from the data alone, and should be further enhanced by the expertise of PAWS staff and leadership. 

* The data indicate that a shorter duration between orientation to first shift remains an opportunity to engage volunteers. While volunteers who have a shorter timeline have a higher likelihood to serve more shifts, it is yet unclear what drives this effect (e.g. more motivated volunteers) and whether there may be an optimal interval between orientation and first shift. 

* Mentee shifts have been a successful factor for promoting volunteer engagement in the first half of 2018. We therefore believe that continuing this program, and perhaps conducting more targeted analyses on this subgroup, would be a worthwhile avenue to pursue further. 

* Disengagement is lower than last year, and it will be interesting to observe whether this trend is maintained once the full year's data is available. 

* In order to improve the speed of data analysis and the usefulness of these analyses for PAWS, we would need to know which data should be monitored at what frequency, how this should be made available to PAWS (e.g. a pdf report, a web portal, etc.), and how PAWS would use these results. Additionally, specific research questions that would be of highest value to PAWS could be tackled first and results delivered in more targeted reports. 
