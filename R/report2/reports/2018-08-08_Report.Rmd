...
In this section, we considered a volunteer to be disengaged if more than 90 days passed since the date of their last recorded shift. All analyses in this section were performed for volunteers that did orientation between Jan 01 2018 and May 01 2018 in order to have a full mapping of their service timeline. 

From this volunteer pool, results suggest that approximately 20% of orientation attendees at any location disengage after orientation (which is a dramatic drop from 50% in 2017). Specifically, 20% of orientation attendees at Grays Ferry have no record of service, while this number stands at 18.52% at Grant Ave, and 21% at PAC. While the proportion of volunteers with only 1 shift recorded was approximately twice as high as in 2017 (approximately 13% across locations), this remains a fairly small percentage of volunteers, with the majority of new volunteers serving 2 or more shifts across all locations. 
