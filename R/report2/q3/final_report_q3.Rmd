...
value <- c(71*0.225, 71*0.141, 71*0.634, 71* 0.127)
label <- c("no service", "1 shift", "2-9 shifts", "10+ shifts")
site <- c("GF")
pct <- c("22.5%", "14.1%", "53.4%","12.7%")
gf <- data.frame(value, label, site, pct)

value <- c(46*0.217, 46*0.174, 46*0.609, 46*0.174 )
label <- c("no service", "1 shift", "2-9 shifts", "10+ shifts")
site <- c("NE")
pct <- c("21.7%", "17.4%", "60.9%","17.4%")
ne <- data.frame(value, label, site, pct)

value <- c(87*0.241, 87*0.138, 87*0.621, 87*0.149 )
label <- c("no service", "1 shift", "2-9 shifts", "10+ shifts")
site <- c("PAC")
pct <- c("24.1%", "13.8%", "62.1%","14.9%")
