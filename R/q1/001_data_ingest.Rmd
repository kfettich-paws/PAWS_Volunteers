...
dates <- merge(select(master, ID, Date.entered, Start.date, Orientation.Date, Status), signup, by = "ID", all.x = TRUE)
...
I can clearly see either some data entry errors or some other things I need to consider like secondary orientation.
