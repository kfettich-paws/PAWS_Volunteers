...
I cleaned the City variable and converted all zip code to 5 digit level.
```{r clean_city}
master_clean <- master %>%
...
final_data$days_since_last <- max(service_clean$From.date) - final_data$last_recorded_date
